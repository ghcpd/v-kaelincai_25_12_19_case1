// Fixed script for course platform - robust DOM handling and user-friendly detail panel

// Embedded course data (kept for demo simplicity)
const coursesData = {
    "courses": [
        {
            "id": 1,
...
// Graceful global error handler (logs and shows minimal user-friendly message)
window.addEventListener('error', function(event) {
    console.error('Unhandled error:', event.error || event.message);
    // Show unobtrusive message instead of crashing the page
...
function showCourseDetail(courseId) {
    try {
        ...
        // Make panel visible and set accessible state
